...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/+DO2UXz8UpLlhMTRl")]])
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        f"🎉Congrats! You are using MJ TEAM:\n\n"
        ...
        f"**If you have any questions, feel free to ask [MJ TEAM](https://t.me/+DO2UXz8UpLlhMTRl)! 💬**\n"
        )
    ) 
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [MJ TEAM](https://t.me/+DO2UXz8UpLlhMTRl)"
